...
import { AreaChart,ColumnChart,StackedAreaChart,GroupedColumnChart,GaugeChart } from 'bizcharts';
...
export default class Analysis extends Component {
  render() {
    return (
      ...
      <Row gutter={[16,16]}>
         <Col {...RowSpan}>
          <Card title={ <Statistic title="面积图"  value={55555} ></Statistic>} footer={<span>陆地占有率 50.9%</span>}>
            <StackedAreaChart
